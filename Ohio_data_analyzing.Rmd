...
```
From this graph we can see that highest drug overdose death for Ohio is caused by  Cocaine and Synthetic opioids,methadone . The following Drug Categories cause high overdose death is opioids.
...
```
In the graph of Drug Overdose Deaths with Drug Categories by Year, I can observe that year 2017 have higher number of drug overdose death than other years.
...
In the graph of Each month Drug Overdose Death Within a Year, we are able to see the trend changing of drug overdose in continuous years. The highest percentage of drug overdose death is 2017. There is increase percentage of cause drug overdose death in 2020 which is by the COVID-19.
...
In the graph of Number of Drug Overdose Deaths with Drug Categories by Year, we can see that drug overdose death in Ohio keep increasing over the years with Heroin, Opioids, Synthetic Opioids.Since we miss data from 2015-2018, so we just include 2019-2021 in this graph.
...
Ohio around Cincinnati,KY,IN have the higher income compare to other part of Ohio and US.
...
We can see that the highest death rate occur in south Ohio across the years. From the income graph, OH around Cincinnati,KY,IN have the higher income compare to other part of Ohio, which is close to the region have higher death rate. 
