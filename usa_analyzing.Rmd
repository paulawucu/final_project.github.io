...
```
 ...
 - This is a graph based on the drug type. It can be seen from the figure that the number of deaths caused by overdose of opioids has been ranked first during 2015-2021. However, the deaths of methadone have been in a slow-down trend. The reason is: blablablablabalb
...
The graph of drug overdose death in each state over time:
